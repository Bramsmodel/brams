...
contains
  ...
  subroutine Brams2Post_8d (one_post_variable, oneBramsGrid, onePostGrid, oneBasicFields)
    ...
    case ('SMOIST')
       call GetVarFromMemToOutput ('SOIL_WATER', oneBramsGrid%currGrid, ScrT4N01, oneBasicFields)
    ...
    case ('SENERGY')
       ...
       call get_leaf_soil (ScrT4N01, OutputField)
    case ('SLTEX_P')
       call GetVarFromMemToOutput ('SOIL_TEXT', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case default
