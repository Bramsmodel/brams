module ModPostOneField2d
  ...
  real, allocatable :: convprec(:,:)
  real, allocatable :: totprec(:,:)
  logical :: alloc2d = .true. 

contains


  subroutine Brams2Post_2d (one_post_variable, oneBramsGrid, onePostGrid, oneBasicFields)
    include "constants.h"
    ...
    case ('TOTPCP')
       call getAccComponents(oneBramsGrid, OutputField, oneBasicFields)
       OutputField = max(OutputField, 0.0)
    case ('ACCCON')
       OutputField = getAconpr(oneBramsGrid, oneBasicFields)
       OutputField = max(OutputField, 0.0)
    case ('CONVPREC')
       OutputField = getAconpr(oneBramsGrid, oneBasicFields)-convprec
       convprec    = getAconpr(oneBramsGrid, oneBasicFields) ! save for the next step
       !--- output mm/hour
       OutputField = max(OutputField, 0.0)/(frqanl/3600.)

    case ('RSHORT')
       call GetVarFromMemToOutput ('RSHORT', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('RLONG')
       call GetVarFromMemToOutput ('RLONG', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('SEA_PRESS')
       ...
       call GetVarFromMemToOutput ('RV', oneBramsGrid%currGrid, ScrT3N03, oneBasicFields)
       call rams_comp_thetv (ScrT3N02, ScrT3N03)
       OutputField = ScrT3N03(:, :, 1)
       call rams_comp_slpmm5 (ScrT3N02, ScrT3N01, ScrT2N01, OutputField)
    case ('CAPE')
       call GetVarFromMemToOutput ('RV', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
       call GetVarFromMemToOutput ('THETA', oneBramsGrid%currGrid, ScrT3N03, oneBasicFields)
    ...
    case ('TOPO')
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('PRECIP')
       call getAccComponents(oneBramsGrid, OutputField, oneBasicFields)
       ScrT2N01 = getAconpr(oneBramsGrid, oneBasicFields)
       OutputField = OutputField + ScrT2N01
       OutputField = max(OutputField, 0.0)
    case ('TOTPREC')
       call getAccComponents(oneBramsGrid, ScrT2N02, oneBasicFields)
       ScrT2N01 = getAconpr(oneBramsGrid, oneBasicFields)
       ...
       OutputField = max(OutputField, 0.0)/(frqanl/3600.)
    case ('LE')
       call GetVarFromMemToOutput ('SFLUX_R', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
    ...
    case ('H')
       call GetVarFromMemToOutput ('SFLUX_T', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       call rams_comp_dn0 (ScrT3N01, ScrT3N02, ScrT3N03, ScrT2N01, oneBramsGrid%pi01dn, &
            oneBramsGrid%th01dn, oneBramsGrid%ztn, oneBramsGrid%ztop, oneBramsGrid%dzmn)
       call rams_get_surface(ScrT2N01, ScrT3N03)
    ...
    case ('RLONGUP')
       call GetVarFromMemToOutput ('RLONGUP', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('ALBEDT')
       call GetVarFromMemToOutput ('ALBEDT', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('TEMPC2M')
       call GetVarFromMemToOutput ('UP', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       call GetVarFromMemToOutput ('VP', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
       call rams_comp_speed (ScrT3N01, ScrT3N02)
       call GetVarFromMemToOutput ('THETA', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
       call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N03, oneBasicFields)
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       call GetVarFromMemToOutput ('USTAR', oneBramsGrid%currGrid, ScrT6N01, oneBasicFields)
       call GetVarFromMemToOutput ('PATCH_ROUGH', oneBramsGrid%currGrid, ScrT6N02, oneBasicFields)
       call GetVarFromMemToOutput ('CAN_TEMP', oneBramsGrid%currGrid, ScrT6N03, oneBasicFields)
       call GetVarFromMemToOutput ('PATCH_AREA', oneBramsGrid%currGrid, ScrT6N04, oneBasicFields)
       call GetVarFromMemToOutput ('TSTAR', oneBramsGrid%currGrid, ScrT6N05, oneBasicFields)
    ...
    case ('RH2M')
       ...
       !real :: OutputField(oneBramsGrid%mxp, oneBramsGrid%myp)
       call GetVarFromMemToOutput ('RV2MJ', oneBramsGrid%currGrid, ScrT2N02, oneBasicFields)
       ScrT2N02 = ScrT2N02 * 1.e3
       call GetVarFromMemToOutput ('T2MJ', oneBramsGrid%currGrid, ScrT2N03, oneBasicFields)
       call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       ...
       OutputField = max(OutputField, 0.0)
    case ('SST')
       call GetVarFromMemToOutput ('SOIL_ENERGY', oneBramsGrid%currGrid, ScrT4N01, oneBasicFields)
       call rams_fill_sst (oneBramsGrid%nzg, OutputField, ScrT4N01)
    case ('LAND')
       call GetVarFromMemToOutput ('PATCH_AREA', oneBramsGrid%currGrid, ScrT6N01, oneBasicFields)
       call rams_comp_1minus(OutputField, ScrT6N01)
    case ('PWT')
       ScrT3N05 = 0.0
       call GetVarFromMemToOutput ('RV', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       ScrT3N05 = ScrT3N05 + ScrT3N04
       call GetVarFromMemToOutput ('RCP', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       ScrT3N05 = ScrT3N05 + ScrT3N04
       call GetVarFromMemToOutput ('RRP', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       ScrT3N05 = ScrT3N05 + ScrT3N04
       call GetVarFromMemToOutput ('RPP', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       ScrT3N05 = ScrT3N05 + ScrT3N04
       call GetVarFromMemToOutput ('RSP', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       ScrT3N05 = ScrT3N05 + ScrT3N04
       !-For GThompson microphysics micphys_type>1 : RAP does not exist
       if(mcphys_type .le. 1) then
          call GetVarFromMemToOutput ('RAP', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
          ScrT3N05 = ScrT3N05 + ScrT3N04
          call GetVarFromMemToOutput ('RHP', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
          ScrT3N05 = ScrT3N05 + ScrT3N04
       endif
       call GetVarFromMemToOutput ('RGP', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       ScrT3N05 = ScrT3N05 + ScrT3N04
    ...
    case ('TD2M')
       ...
       call GetVarFromMemToOutput ('VP', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
       call rams_comp_speed (ScrT3N01, ScrT3N02)
       call GetVarFromMemToOutput ('RV', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
       call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N03, oneBasicFields)
       call GetVarFromMemToOutput ('THETA', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       call GetVarFromMemToOutput ('USTAR', oneBramsGrid%currGrid, ScrT6N01, oneBasicFields)
       call GetVarFromMemToOutput ('PATCH_ROUGH', oneBramsGrid%currGrid, ScrT6N02, oneBasicFields)
       call GetVarFromMemToOutput ('CAN_RVAP', oneBramsGrid%currGrid, ScrT6N03, oneBasicFields)
       call GetVarFromMemToOutput ('PATCH_AREA', oneBramsGrid%currGrid, ScrT6N04, oneBasicFields)
       call GetVarFromMemToOutput ('RSTAR', oneBramsGrid%currGrid, ScrT6N05, oneBasicFields)
       call GetVarFromMemToOutput ('CAN_TEMP', oneBramsGrid%currGrid, ScrT6N06, oneBasicFields)
       ...
       call RAMS_comp_tempC (OutputField)
    case ('U10M')
       call getWinds10m(oneBramsGrid, 'U', OutputField, oneBasicFields)
    case ('V10M')
       call getWinds10m(oneBramsGrid, 'V', OutputField, oneBasicFields)
    case ('U10MJ')
       call checkUsingJules(one_post_variable%fieldName)
       if (time==0.) then
          call getWinds10m(oneBramsGrid, 'U', OutputField, oneBasicFields)
       else
          call GetVarFromMemToOutput ('U10MJ', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       endif
    case ('V10MJ')
       call checkUsingJules(one_post_variable%fieldName)
       if (time==0.) then
          ...
          call GetVarFromMemToOutput ('V10MJ', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       endif
    case ('U10MJ1HR')
       call checkUsingJules(one_post_variable%fieldName)
       ...
       call GetVarFromMemToOutput ('U10MJ1hr', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       ! output binary field
    ...
    case ('T2MJ')
       ...
       if (time==0.) then
          ...
          call GetVarFromMemToOutput ('T2MJ', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    ...
    case ('T2MJ_MAX')
       ...
       if (time==0.) then
          ...
          call GetVarFromMemToOutput ('T2MJ_MAX', oneBramsGrid%currGrid, OutputField, oneBasicFields)
          OutputField = OutputField - 273.16
          where (OutputField<-70.) OutputField = undef
    ...
    case ('T2MJ_MIN')
       ...
       if (time==0.) then
          ...
          call GetVarFromMemToOutput ('T2MJ_MIN', oneBramsGrid%currGrid, OutputField, oneBasicFields)
          OutputField = OutputField - 273.16
          where (OutputField<-70.) OutputField = undef
    ...
    case ('ZI')
       ...
       call GetVarFromMemToOutput ('TKEP', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
       ...
       return
    case ('HT_FLUXJ')
       call GetVarFromMemToOutput ('ht_fluxj', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('CSJ')
       call checkUsingJules(one_post_variable%fieldName)
       onePostGrid%fieldName = one_post_variable%fieldName
       onePostGrid%ivar_type = one_post_variable%ivar_type
       if (time==0.) then
          ...
          call GetVarFromMemToOutput ('CSJ', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    ...
    case ('RV2MJ')
       ...
       if (time==0.) then
          ...
          call GetVarFromMemToOutput ('RV', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
          ...
          call GetVarFromMemToOutput ('RV2MJ', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       ...
       return
    case ('ZITHETA')
       call GetVarFromMemToOutput ('THETA', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       call GetVarFromMemToOutput ('RCP', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
       call get_ZItheta(OutputField, ScrT3N01, ScrT3N02, oneBramsGrid%ztn)
    case ('GPP')
       call GetVarFromMemToOutput ('GPP', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('RESP_S')
       call GetVarFromMemToOutput ('RESP_S', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('RESP_P')
       call GetVarFromMemToOutput ('RESP_P', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('NPP')
       call GetVarFromMemToOutput ('NPP', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('SFC_PRESS')
       call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       call rams_comp_sfc_press (OutputField, ScrT3N01)
    case ('AOT500')
       call GetVarFromMemToOutput ('AOT', oneBramsGrid%currGrid, ScrT7N01, oneBasicFields)
       Outputfield(:, :) = ScrT7N01(:, :, 11)
    case ('AOT550')
       call GetVarFromMemToOutput ('AOT', oneBramsGrid%currGrid, ScrT7N01, oneBasicFields)
       Outputfield(:, :) = ScrT7N01(:, :, 10)
    case ('LMO')
       call GetVarFromMemToOutput ('LMO', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('PBLHGT')
       call GetVarFromMemToOutput ('PBLHGT', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('TD2MJ')
       call checkUsingJules(one_post_variable%fieldName)
       onePostGrid%fieldName = one_post_variable%fieldName
       onePostGrid%fieldUnits = one_post_variable%fieldUnits
       ...
       if (time==0.) then
          ...
          call GetVarFromMemToOutput ('RV2MJ', oneBramsGrid%currGrid, OutputField, oneBasicFields)
          OutputField = OutputField * 1.e3
          call GetVarFromMemToOutput ('T2MJ', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
          call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
          ScrT2N03 = (ScrT3N01(:, :, 1) + ScrT3N01(:, :, 2)) * 0.5
    ...
    case ('CO_SFC')
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('COP', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
       Outputfield(:, :) = OutputField3d(:, :, 2)
       OutputField = max(OutputField, 0.0)
       OutputField = OutputField * (28.96 / 28.)
    case ('O3_SFC')
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('O3P', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
       Outputfield(:, :) = OutputField3d(:, :, 2)
       OutputField = max(OutputField, 0.0)
       OutputField = OutputField * (28.96 / 48.)
    case ('NO_SFC')
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('NOP', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
       Outputfield(:, :) = OutputField3d(:, :, 2)
       OutputField = max(OutputField, 0.0)
       OutputField = OutputField * (28.96 / 30.)
    case ('HNO3_SFC')
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('HNO3P', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
       Outputfield(:, :) = OutputField3d(:, :, 2)
       OutputField = max(OutputField, 0.0)
       OutputField = OutputField * (28.96 / 63.)
    case ('NO2_SFC')
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('NO2P', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
       Outputfield(:, :) = OutputField3d(:, :, 2)
       OutputField = max(OutputField, 0.0)
       OutputField = OutputField * (28.96 / 46.)
    case ('PM25_SFC')
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('bburn2P', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
    ...
    case ('CO2_BURN2D')
       ...
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       call GetVarFromMemToOutput ('CO2_bburn_SRC', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
    ...
    case ('CO2_bioge')
       ...
       call PrepareGradsField (one_post_variable, onePostGrid)
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       call GetVarFromMemToOutput ('CO2_bioge_SRC', oneBramsGrid%currGrid, OutputField3d, oneBasicFields)
       OutputField3d(:, :, 2) = OutputField3d(:, :, 1) * (1. - ScrT2N01(:, :) / oneBramsGrid%ztop) &
            / oneBramsGrid%dztn(2) * 1.e-3  ! convertendo de kg/m3/dia para mg/m2/s
       call OutputGradsField (oneBramsGrid, onePostGrid, OutputField3d)
       return
    case ('CO2_TOTAL')
       call GetVarFromMemToOutput ('CO2P', oneBramsGrid%currGrid, ScrT3N04, oneBasicFields)
       ! call RAMS_comp_noneg(n1,n2,n3,a)
    ...
    case ('PM25WD')
       ...
       call GetVarFromMemToOutput ('bburn2WD', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       ! call RAMS_comp_mults(n1,n2,n3,a,1.e-9)  ! converte de 1e-9 kg/kg para 1 kg/kg
       OutputField = OutputField * 1.e-9
    case ('PMINT')
       ! because is 3d in a 2d variable definition, need to set onePostGrid and call OutputGradsField
       ...
       return
    case ('APRGR')
       call GetVarFromMemToOutput ('accpr_gr', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       OutputField = max(OutputField, 0.0)
    case ('APRST')
       call GetVarFromMemToOutput ('accpr_st', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       OutputField = max(OutputField, 0.0)
    case ('APRMC')
       call GetVarFromMemToOutput ('accpr_mc', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       OutputField = max(OutputField, 0.0)
    case ('APRW')
       call GetVarFromMemToOutput ('accpr_w', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       OutputField = max(OutputField, 0.0)
    case ('APRAS')
       call GetVarFromMemToOutput ('accpr_as', oneBramsGrid%currGrid, OutputField, oneBasicFields)
       OutputField = max(OutputField, 0.0)
    case ('PODA')
       call checkUsingJules(one_post_variable%fieldName)
       !--- rv_2.0m ---
       call GetVarFromMemToOutput ('RV2MJ', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       ScrT2N01 = ScrT2N01 * 1.e3
       !--- tempk2m ---
       call GetVarFromMemToOutput ('T2MJ', oneBramsGrid%currGrid, ScrT2N02, oneBasicFields)
       !--- PI ---
       call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N03, oneBasicFields)
       ScrT2N03 = (ScrT3N03(:, :, 1) + ScrT3N03(:, :, 2)) * 0.5
       ...
       !-compute slp (hPa)
       call GetVarFromMemToOutput ('TOPT', oneBramsGrid%currGrid, ScrT2N04, oneBasicFields)
       call GetVarFromMemToOutput ('THETA', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       call GetVarFromMemToOutput ('RV', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
    ...
    case ('P47UM')
       call GetVarFromMemToOutput ('P47UM', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('EXD14')
       call GetVarFromMemToOutput ('EXD14', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('DNADV')
       call GetVarFromMemToOutput ('DNADV', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('SCUPM')
       call GetVarFromMemToOutput ('SCUPM', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('SCUPH')
       call GetVarFromMemToOutput ('SCUPH', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('CIEHE')
       call GetVarFromMemToOutput ('CIEHE', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('UVIND')
       call GetVarFromMemToOutput ('UVIND', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('ERYTH')
       call GetVarFromMemToOutput ('ERYTH', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('OCTLV')
       call GetVarFromMemToOutput ('OCTLV', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('PHYTO')
       call GetVarFromMemToOutput ('PHYTO', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('PHYPH')
       call GetVarFromMemToOutput ('PHYPH', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('PHYPR')
       call GetVarFromMemToOutput ('PHYPR', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('CAPIG')
       call GetVarFromMemToOutput ('CAPIG', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('PLDCW')
       call GetVarFromMemToOutput ('PLDCW', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('PLDFL')
       call GetVarFromMemToOutput ('PLDFL', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('MFUP')
       call GetVarFromMemToOutput ('MFUP', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('MFDD')
       call GetVarFromMemToOutput ('MFDD', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('MFSH')
       call GetVarFromMemToOutput ('MFSH', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    ...
    case ('AA1_BL')
       call GetVarFromMemToOutput ('accpr_as', oneBramsGrid%currGrid, OutputField, oneBasicFields)
    case ('L_CLD_FRAC')
       call GetVarFromMemToOutput ('CLOUD_FRACTION', oneBramsGrid%currGrid, ScrT3N01, oneBasicFields)
       call GetVarFromMemToOutput ('PI', oneBramsGrid%currGrid, ScrT3N02, oneBasicFields)
       call rams_comp_press(ScrT3N02) 
  ...
  function getAconpr(oneBramsGrid, oneBasicFields) result(aconpr)
    ...
    if(hasAconpr(oneBramsGrid%currGrid)) then
       call GetVarFromMemToOutput ('ACONPR', oneBramsGrid%currGrid, aconpr, oneBasicFields)
    else
       aconpr = 0
    end if
  ...
  subroutine getAccComponents(oneBramsGrid, OutputField, oneBasicFields)
    ...
    OutputField = 0.0
    call GetVarFromMemToOutput ('ACCPR', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
    OutputField = OutputField + ScrT2N01
    !-For GThompson microphysics micphys_type>1 : ACCPR is already the total precip
    if(mcphys_type .le. 1) then
       call GetVarFromMemToOutput ('ACCPP', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       OutputField = OutputField + ScrT2N01
       call GetVarFromMemToOutput ('ACCPS', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       OutputField = OutputField + ScrT2N01
       call GetVarFromMemToOutput ('ACCPA', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       OutputField = OutputField + ScrT2N01
       call GetVarFromMemToOutput ('ACCPG', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       OutputField = OutputField + ScrT2N01
       call GetVarFromMemToOutput ('ACCPH', oneBramsGrid%currGrid, ScrT2N01, oneBasicFields)
       OutputField = OutputField + ScrT2N01
    endif
  ...
  subroutine getWinds10m(oneBramsGrid, u_or_v, OutputField, oneBasicFields)
    type(BramsGrid), pointer :: oneBramsGrid
