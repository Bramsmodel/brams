       ...
       !  print *, 'LFR-DBG: run_advance_moisture=',run_advance_moisture
         ...
         if (run_advance_moisture) then
            ...
            if (ifun .eq. 3) then
              ...
              ! print*,'VERIFICAR AM ifun 3=',ims, ime, jms, jme,ids, ide, jds, jde
              ! call flush (6)
               ...
               if (restart) then
                ...
                !   call flush (6)
                 ...
                 !    call flush (6)
                  ...
                  !   print*,'VERIFICAR fndwi ifun 2=',ims, ime, jms, jme,ids, ide, jds, jde
                  !   call flush (6)
                     
                     call interpolate_z2fire(id, 0, 0,&
                                             ids, ide, jds, jde, &
                                             ims, ime, jms, jme, &
                                             ifds, ifde, jfds, jfde, &
                                             ifms, ifme, jfms, jfme, &
                ...
                !   call flush (6)
                 ...
                 !    print*,'VERIFICAR fxlat ifun 2=',ims, ime, jms, jme,ids,ide, jds, jde
                 !    call flush (6)
                     
                     call interpolate_z2fire(id, 1,1, &
                                             ids, ide, jds, jde, &
                                             ims, ime, jms, jme, &
                                             ifds, ifde, jfds, jfde, &
                                             ifms, ifme, jfms, jfme, &
...
!!!!!!!!
            ...
            elseif (ifun .eq. 4) then
               ...
               if (run_fuel_moisture) then
                 ...
                 ! print*,'VERIFICAR fmc_gc ifun 4=',ims, ime, jms, jme,ids, ide,jds, jde
                 ! call flush (6)
...
!!!!!!!!!!!!!!
  ...
  subroutine check_fmesh(ids, ide, ifds, ifde, ir, s)
   ...
   ! Verifica se a relação entre os índices da malha principal e os subíndices do fire mesh
   ! é consistente com o fator de refinamento (ir).
...
!!!!
      !print *, "estou na rotina driver_physna rotina set_flags e esta a ler crown que Ã©", crown
