...
!!$  call azero (ibins*ibins*3,akbarx)
    ...
    do id1cc = 1,nd1cc
       ...
       call sxy(x,amk0,ank0,amk,ank,akbarx(:,:,1))
  ...
  subroutine sxy(x,amkd,ankd,amk,ank,akbar)
    ...
    real, dimension(:), intent(in)       :: amkd, ankd
    real, dimension(:), intent(out)      :: amk, ank
    real, dimension(:,:), intent(in) :: akbar
  ...
  subroutine data(x,diam,akbar,ibins)
    ...
    real, dimension(:), intent(out)     :: x, diam
    real, dimension(:,:), intent(out) :: akbar
  ...
  subroutine initg(r1,r2,n1,n2,gnu1,gnu2,diam,x,amk,ank  &
    ...
    real, dimension(:), intent(in) :: x,diam
    real, dimension(:), intent(out) :: amk,ank,amk1,ank1,amk2,ank2
  ...
  subroutine sumn(ank,amk,imin,imax,ibins,sun,sum)
    ...
    real, dimension(:), intent(in) :: ank,amk
