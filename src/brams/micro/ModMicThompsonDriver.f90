...
contains
  ...
  subroutine brams_to_mic_thompson(ia,ja,iz,jz, &
    ...
    ! print*,"1pp "  ,maxval( oneBasicFields%pp   ),minval( oneBasicFields%pp   ),mynum
    ! print*,"1rtp"  ,maxval( oneBasicFields%rtp  ),minval( oneBasicFields%rtp  ),mynum
    ! print*,"1rv "  ,maxval( oneBasicFields%rv   ),minval( oneBasicFields%rv   ),mynum
    ! print*,"1wp "  ,maxval( oneBasicFields%wp   ),minval( oneBasicFields%wp   ),mynum
    ...
    !- column quantities
    thp  (1:m1)= oneBasicFields%thp  (1:m1,i,j)
    theta(1:m1)= oneBasicFields%theta(1:m1,i,j)
    pp   (1:m1)= oneBasicFields%pp   (1:m1,i,j)
    rtp  (1:m1)= oneBasicFields%rtp  (1:m1,i,j)
    rv   (1:m1)= oneBasicFields%rv   (1:m1,i,j)
    wp   (1:m1)= oneBasicFields%wp   (1:m1,i,j)
    ...
    !- column quantities
    oneBasicFields%thp  (1:m1,i,j) =thp  (1:m1) 
    oneBasicFields%theta(1:m1,i,j) =theta(1:m1)
    ...
    ! print*,"2pp "  ,maxval( oneBasicFields%pp   ),minval( oneBasicFields%pp   ),mynum
    ! print*,"2rtp"  ,maxval( oneBasicFields%rtp  ),minval( oneBasicFields%rtp  ),mynum
    ! print*,"2rv "  ,maxval( oneBasicFields%rv   ),minval( oneBasicFields%rv   ),mynum
    ! print*,"2wp "  ,maxval( oneBasicFields%wp   ),minval( oneBasicFields%wp   ),mynum
...
end module ModMicThompsonDriver
