...
contains
  ...
  subroutine cldnuc(m1,k1cnuc,k2cnuc,lpw,rv,wp,i,j)
    ...
    integer, intent(in) :: i !**(JP)** not used
    integer, intent(in) :: j !**(JP)** not used
  ...
  subroutine icenuc(m1,kc1,kc2,k1pnuc,k2pnuc,lpw,ngr,rv,dn0,dtlt,i,j)
    ...
    integer, intent(out) :: k1pnuc
    integer, intent(out) :: k2pnuc
    integer, intent(in) :: lpw
...
!!$      endif
  ...
  subroutine contnuc (rx,cx,tx,vap,press  &
    ...
    integer, intent(in) :: i !**(JP)** unused
    integer, intent(in) :: k !**(JP)** unused
    real, intent(in) :: rx
    real, intent(in) :: cx
    real, intent(in) :: tx
    real, intent(in) :: vap
    real, intent(in) :: press
    real, intent(in) :: dynvisc
    real, intent(in) :: thrmcon
    real, intent(in) :: tair
    real, intent(in) :: tairc
    real, intent(out) :: pbvi
    real, intent(out) :: ptvi
    real, intent(out) :: pdvi
    real, intent(out) :: ptotvi
    real, intent(in) :: dn1
    real, intent(in) :: dtlt
