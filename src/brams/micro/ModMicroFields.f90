...
module ModMicroFields
  ...
  type MicroFields
     ...
     real, contiguous, pointer :: rcp(:,:,:) => null()
     real, contiguous, pointer :: rdp(:,:,:) => null()
     real, contiguous, pointer :: rrp(:,:,:) => null()
     real, contiguous, pointer :: rpp(:,:,:) => null()
     real, contiguous, pointer :: rsp(:,:,:) => null()
     real, contiguous, pointer :: rap(:,:,:) => null()
     real, contiguous, pointer :: rgp(:,:,:) => null()
     real, contiguous, pointer :: rhp(:,:,:) => null()
     real, contiguous, pointer :: ccp(:,:,:) => null()
     real, contiguous, pointer :: cdp(:,:,:) => null()
     real, contiguous, pointer :: crp(:,:,:) => null()
     real, contiguous, pointer :: cpp(:,:,:) => null()
     real, contiguous, pointer :: csp(:,:,:) => null()
     real, contiguous, pointer :: cap(:,:,:) => null()
     real, contiguous, pointer :: cgp(:,:,:) => null()
     real, contiguous, pointer :: chp(:,:,:) => null()
     real, contiguous, pointer :: cccnp(:,:,:) => null()
     real, contiguous, pointer :: gccnp(:,:,:) => null()
     real, contiguous, pointer :: cifnp(:,:,:) => null()
     real, contiguous, pointer :: q2(:,:,:) => null()
     real, contiguous, pointer :: q6(:,:,:) => null()
     real, contiguous, pointer :: q7(:,:,:) => null()
     real, contiguous, pointer :: rei(:,:,:) => null()
     real, contiguous, pointer :: rel(:,:,:) => null()
     real, contiguous, pointer :: cldfr(:,:,:) => null()
     real, contiguous, pointer :: cccmp(:,:,:) => null()
     real, contiguous, pointer :: gccmp(:,:,:) => null()
     real, contiguous, pointer :: pcpvr(:,:,:) => null()
     real, contiguous, pointer :: pcpvp(:,:,:) => null()
     real, contiguous, pointer :: pcpvs(:,:,:) => null()
     real, contiguous, pointer :: pcpva(:,:,:) => null()
     real, contiguous, pointer :: pcpvg(:,:,:) => null()
     real, contiguous, pointer :: pcpvh(:,:,:) => null()

     ! Variables to be dimensioned by (nnxp,nyp)
     real, contiguous, pointer :: accpr(:,:) => null()
     real, contiguous, pointer :: accpp(:,:) => null()
     real, contiguous, pointer :: accps(:,:) => null()
     real, contiguous, pointer :: accpa(:,:) => null()
     real, contiguous, pointer :: accpg(:,:) => null()
     real, contiguous, pointer :: accph(:,:) => null()
     real, contiguous, pointer :: pcprr(:,:) => null()
     real, contiguous, pointer :: pcprp(:,:) => null()
     real, contiguous, pointer :: pcprs(:,:) => null()
     real, contiguous, pointer :: pcpra(:,:) => null()
     real, contiguous, pointer :: pcprg(:,:) => null()
     real, contiguous, pointer :: pcprh(:,:) => null()
     real, contiguous, pointer :: pcpg(:,:) => null()
     real, contiguous, pointer :: qpcpg(:,:) => null()
     real, contiguous, pointer :: dpcpg(:,:) => null()
