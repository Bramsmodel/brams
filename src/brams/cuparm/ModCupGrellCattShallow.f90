...
module ModCupGrellCattShallow
  private
  public :: cuparth_shal
contains


  subroutine cuparth_shal(&
       ccatt, mynum, mgmxp, mgmyp, mgmzp, m1, m2,m3, ia,iz, ja,jz, &
       i0, j0, maxiens, iens, ngrid, ngrids_cp, dtime, time, ua, va, wa, &
       theta, thetail, pp, pi0, dn0, rv, tke, tkmin, rcp, topt, rtgt, &
       tht, rtt, pt, outtem, outrt, ierr4d, jmin4d, kdet4d, k224d, &
       kbcon4d, ktop4d, kpbl4d, kstabi4d, kstabm4d, xmb4d, edt4d, zcup5d, &
       pcup5d, enup5d, endn5d, deup5d, dedn5d, zup5d, zdn5d, prup5d, clwup5d, &
       tup5d, upmf, xierr, xktop, xkbcon, xk22, xierr_dp, confrq, frqanl,    &
       deltaxy2, patch_area, npat, level, trigg, autoconv)
    ...
    real, intent(in) :: time
    real, intent(in) :: ua(m1,m2,m3)
    real, intent(in) :: va(m1,m2,m3)
    real, intent(in) :: wa(m1,m2,m3)
    real, intent(in) :: theta(m1,m2,m3)
    real, intent(in) :: thetail(m1,m2,m3) !**(JP)** unused
    ...
    real, intent(in) :: rtgt(m2,m3) !**(JP)** unused
    real, intent(in) :: tht(m1,m2,m3)
    real, intent(in) :: rtt(m1,m2,m3)
    real, intent(in) :: pt(m1,m2,m3)
    real, intent(inout) :: outtem(m1,m2,m3)
    real, intent(inout) :: outrt(m1,m2,m3)
    ...
    real, intent(inout) :: zcup5d(mgmzp,mgmxp,mgmyp,maxiens,ngrids_cp)
    real, intent(inout) :: pcup5d(mgmzp,mgmxp,mgmyp,maxiens,ngrids_cp)
    real, intent(inout) :: enup5d(mgmzp,mgmxp,mgmyp,maxiens,ngrids_cp)
    real, intent(inout) :: endn5d(mgmzp,mgmxp,mgmyp,maxiens,ngrids_cp)
    real, intent(inout) :: deup5d(mgmzp,mgmxp,mgmyp,maxiens,ngrids_cp)
    real, intent(inout) :: dedn5d(mgmzp,mgmxp,mgmyp,maxiens,ngrids_cp)
    ...
    real, intent(inout) :: upmf(m2,m3)
    real, intent(inout) :: xierr(m2,m3)
    real, intent(inout) :: xktop(m2,m3)
    real, intent(inout) :: xkbcon(m2,m3)
    real, intent(inout) :: xk22(m2,m3)
    real, intent(inout) :: xierr_dp(m2,m3)
    real, intent(in) :: confrq
    real, intent(in) :: frqanl
    real, intent(in) :: deltaxy2
    real, intent(in) :: patch_area(m2,m3,npat)
    integer, intent(in) :: npat
    integer, intent(in) :: level !**(JP)** unused
  ...
  subroutine CUP_enss_shal(ccatt,ngrid,mynum,m1,m2,m3,i0,j0,ipr,jpr, &
    ...
    integer, intent(in) :: ccatt
    integer, intent(in) :: ngrid !**(JP)** not used
    integer, intent(in) :: mynum !**(JP)** not used
    integer, intent(in) :: m1
    integer, intent(in) :: m2
    integer, intent(in) :: m3
    integer, intent(in) :: i0 !**(JP)** not used
    integer, intent(in) :: j0 !**(JP)** not used
    integer, intent(in) :: ipr
    integer, intent(in) :: jpr
    integer, intent(in) :: mgmxp
    integer, intent(in) :: mgmyp
    integer, intent(in) :: mgmzp
    integer, intent(in) :: maxiens  !**(JP)** not used
    ...
    integer, intent(inout) :: mix
    integer, intent(in) :: mjx
    integer, intent(in) :: mkx
    real, intent(in) :: xland(mgmxp,mgmyp)
    ...
    real, intent(out) :: outq(mgmxp,mgmzp)
    real, intent(in) :: dtime
    real, intent(in) :: psur(mgmxp)
    real, intent(in) :: tcrit
    real, intent(in) :: time
    real, intent(in) :: omeg(mgmxp,mgmzp)
    real, intent(in) :: tkeg(mgmxp,mgmzp)
    real, intent(in) :: rcpg(mgmxp,mgmzp)
    real, intent(in) :: tkmin
    integer, intent(inout) :: ierr4d(mgmxp)
    integer, intent(inout) :: jmin4d(mgmxp)
    integer, intent(inout) :: kdet4d(mgmxp)
    integer, intent(inout) :: k224d(mgmxp)
    integer, intent(inout) :: kbcon4d(mgmxp)
    integer, intent(inout) :: ktop4d(mgmxp)
    integer, intent(inout) :: kpbl4d(mgmxp)
    integer, intent(inout) :: kstabi4d(mgmxp)
    integer, intent(inout) :: kstabm4d(mgmxp)
    real, intent(inout) :: xmb4d(mgmxp)
    real, intent(inout) :: edt4d(mgmxp)
    real, intent(inout) :: zcup5d(mgmzp,mgmxp)
    real, intent(inout) :: pcup5d(mgmzp,mgmxp)
    real, intent(inout) :: enup5d(mgmzp,mgmxp)
    real, intent(inout) :: endn5d(mgmzp,mgmxp)
    real, intent(inout) :: deup5d(mgmzp,mgmxp)
    real, intent(inout) :: dedn5d(mgmzp,mgmxp)
    real, intent(inout) :: zup5d(mgmzp,mgmxp)
    real, intent(inout) :: zdn5d(mgmzp,mgmxp)
    real, intent(inout) :: prup5d(mgmzp,mgmxp)
    real, intent(inout) :: clwup5d(mgmzp,mgmxp)
    real, intent(inout) :: tup5d(mgmzp,mgmxp)
    real, intent(inout) :: upmf(m2,m3)
    real, intent(inout) :: xierr(m2,m3)
    real, intent(inout) :: xktop(m2,m3)
    real, intent(inout) :: xkbcon(m2,m3)
    ...
    real, intent(in) :: dhdt(mgmxp,mgmzp)
    integer, intent(in) :: trigg
    integer, intent(in) :: actual_iens
    integer, intent(in) :: autoconv
...
end module ModCupGrellCattShallow
