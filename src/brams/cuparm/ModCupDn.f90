...
contains
  ...
  subroutine cup_dd_he(hes_cup, zd, hcd, z_cup, cdd, entr, jmin, ierr,  &
    ...
    real, intent(inout) :: zd(:,:) ! (mgmxp,mgmzp) **(JP)** unused
    real, intent(inout) :: hcd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: z_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: cdd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: entr
    integer, intent(in) :: jmin(:) ! (mgmxp)
    ...
    integer, intent(in) :: kdet(:) ! (mgmxp) **(JP)** unused
    real, intent(inout) :: dby(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: he_cup(:,:) ! (mgmxp,mgmzp) **(JP)** unused
  ...
  subroutine cup_dd_moisture(j, zd, hcd, hes_cup, qcd, qes_cup, pwd, q_cup,  &
    ...
    ! arguments
    integer, intent(in) :: j
    real, intent(in) :: zd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: hcd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: hes_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(inout) :: qcd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: qes_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(inout) :: pwd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: q_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: z_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: cdd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: entr
    integer, intent(in) :: jmin(:) ! (mgmxp)
    integer, intent(inout) :: ierr(:) ! (mgmxp)
    real, intent(in) :: gamma_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(inout) :: pwev(:) ! (mgmxp)
    integer, intent(in) :: mix ! **(JP)** unused
    integer, intent(in) :: mgmxp
    integer, intent(in) :: mkx
    integer, intent(in) :: mgmzp
    integer, intent(in) :: istart
    integer, intent(in) :: iend
    real, intent(inout) :: bu(:) ! (mgmxp)
    real, intent(inout) :: qrcd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: q(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: he(:,:) ! (mgmxp,mgmzp) **(JP)** unused
    real, intent(in) :: hc(:,:) ! (mgmxp,mgmzp) **(JP)** unused
    real, intent(in) :: t_cup(:,:) ! (mgmxp,mgmzp) **(JP)** unused
  ...
  subroutine cup_dd_nms(zd, z_cup, cdd, entr, jmin, ierr,      &
    ...
    ! arguments
    real, intent(inout) :: zd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: z_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(inout) :: cdd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: entr
    integer, intent(in) :: jmin(:) ! (mgmxp)
    integer, intent(inout) :: ierr(:) ! (mgmxp)
    integer, intent(in) :: mix !**(JP)** unused
  ...
  subroutine cup_dd_aa0(edt, ierr, aa0, jmin, gamma_cup, t_cup,           &
    ...
    ! arguments
    real, intent(in) :: edt(:) ! (mgmxp)
    integer, intent(in) :: ierr(:) ! (mgmxp)
    real, intent(inout) :: aa0(:) ! (mgmxp)
    integer, intent(in) :: jmin(:) ! (mgmxp)
    real, intent(in) :: gamma_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: t_cup(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: hcd(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: hes_cup(:,:) ! (mgmxp,mgmzp)
  ...
  subroutine cup_dd_edt(ierr, us, vs, z, ktop, kbcon, edt, p, pwav,       &
    ...
    ! arguments
    integer, intent(in) :: ierr(:) ! (mgmxp)
    real, intent(in) :: us(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: vs(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: z(:,:) ! (mgmxp,mgmzp)
    integer, intent(in) :: ktop(:) ! (mgmxp)
    integer, intent(in) :: kbcon(:) ! (mgmxp)
    real, intent(inout) :: edt(:) ! (mgmxp)
    real, intent(in) :: p(:,:) ! (mgmxp,mgmzp)
    real, intent(in) :: pwav(:) ! (mgmxp)
    real, intent(in) :: pwev(:) ! (mgmxp)
    integer, intent(in) :: mix !**(jp)** unused
    integer, intent(in) :: mgmxp
    integer, intent(in) :: mkx
    integer, intent(in) :: mgmzp
    ...
    real, intent(inout) :: edtc(:,:) ! (mgmxp,maxens2)
    real, intent(inout) :: vshear(:) ! (mgmxp)
    real, intent(inout) :: sdp(:) ! (mgmxp)
    real, intent(inout) :: vws(:) ! (mgmxp)
    ! local variables
    integer :: i, kk, k    
