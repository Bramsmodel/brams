...
111    format(/,' MAX N LAT=',f9.3,'  MIN S LAT=',f9.3  &
  ...
  subroutine FieldInit(initflg, oneBasicFields, &
    ...
    call dumset(mzp,mxp,myp,1,mxp,1,myp,ibcon,oneBasicFields%uc,'U')
    call dumset(mzp,mxp,myp,1,mxp,1,myp,ibcon,oneBasicFields%vc,'V')
    call dumset(mzp,mxp,myp,1,mxp,1,myp,ibcon,oneBasicFields%wc,'W')
    call dumset(mzp,mxp,myp,1,mxp,1,myp,ibcon,oneBasicFields%up,'U')
    call dumset(mzp,mxp,myp,1,mxp,1,myp,ibcon,oneBasicFields%vp,'V')
    call dumset(mzp,mxp,myp,1,mxp,1,myp,ibcon,oneBasicFields%wp,'W')
