...
101 format(2i5,2f11.5,i5,2f11.5)
  ...
  subroutine TopReadStoreOwnChunk(ifm, oneControlVars)
    ...
    call ReadStoreOwnChunk(ifm, 25, grid_g(ifm)%topta, "topta", oneControlVars)
    call ReadStoreOwnChunk(ifm, 25, grid_g(ifm)%topzo, "topzo", oneControlVars)
  ...
  subroutine TRSFFieldAndOwnChunk(ifm, oneControlVars)
    ...
    call ReadStoreFullFieldAndOwnChunk(ifm, 25, &
         oneGlobalGridData(ifm)%global_topta, grid_g(ifm)%topta, "topta", oneControlVars)
