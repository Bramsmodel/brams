...
module ModRstilt
  ...
  private
  public :: prep_advflx_to_stilt
  public :: prepare_timeavg_driver
  public :: prep_convflx_to_stilt
contains




  subroutine prep_advflx_to_stilt(mzp,mxp,myp,ia,iz,ja,jz,ng, oneBasicFields)
    !----- Arguments. ----------------------------------------------------------------------!
  ...
  subroutine get_adv_fluxes_for_stilt(mzp,mxp,myp,ia,iz,ja,jz, oneBasicFields)
    include "constants.h"
    type(BasicFields), pointer, intent(in) :: oneBasicFields
