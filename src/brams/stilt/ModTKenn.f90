module ModTKenn
  ...
  use turb_constants, only: &
       nna1,nna2,nnb1,nnb2,nnc1,nnc2,nnc3,nnc4,nnc5                 &
...
!!$    real     , intent(in)    , dimension(:,:)    :: flpu_R,flpv_R,flpw_R
!!$    real     , intent(in)    , dimension(:,:)    :: rtgt, sflux_u, sflux_v, sflux_t
!!$    real     , intent(in)    , dimension(:,:,:) :: tkep, vt3dd, vt3de, theta
!!$    real     , intent(in)    , dimension(:,:,:) :: vt3dj, rv, rtp, dn0, up, vp
!!$    real     , intent(in)    , dimension(:,:,:) :: vegz0, patchz0, ustar
!!$    real     , intent(in)    , dimension(:,:,:) :: tstar, patch_area 
!!$    real     , intent(inout) , dimension(:,:)    :: kpbl
!!$    real     , intent(inout) , dimension(:,:)    :: pblhgt, lmo
!!$    real     , intent(inout) , dimension(:,:,:) :: vt3dh, scr1, tl, sigw
!!$    real     , intent(inout) , dimension(:,:,:) :: vt3di,tket
