...
99  continue
  ...
  subroutine tridiff1_adap(m1,m2,m3,ia,iz,ja,jz,kz,lpx  &
    ...
    enddo
    return
  end subroutine tridiff1_adap
end module ModTurbDiffAdap
