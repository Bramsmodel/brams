...
contains
  ...
  subroutine diffsclr_brams31(m1,m2,m3,ia,iz,ja,jz,jd,  &
    ...
    integer, intent(in) :: iz_1
    integer, intent(in) :: jz_1
    ...
    real, intent(in) :: vkkh ! should be (m1,m2,m3), but is called with a pointer to scalar
    real, intent(in) :: hkkh ! should be (m1,m2,m3), but is called with a pointer to scalar
    ...
    ! hidden procedure to treat vkkh and hkkh as 3D arrays
    call HiddenDiffsclrBrams31(m1,m2,m3,ia,iz,ja,jz,jd,  &
         ia_1,ja_1,ia1,ja1,iz_1,jz_1,iz1,jz1,n,ksf,  &
         scp,sct,vt3da,vt3db,vt3df,vt3dg,  &
         vt3dj,vt3dk,vt3do,vt3dc,dn03i,vt3dl,vt3dm,vt2db,rtgt,sfcflx,  &
         dn0,vkkh,hkkh)
  end subroutine diffsclr_brams31
end module ModDiffSclr




subroutine HiddenDiffsclrBrams31(m1,m2,m3,ia,iz,ja,jz,jd,  &
     ia_1,ja_1,ia1,ja1,iz_1,jz_1,iz1,jz1,n,ksf,  &
     scp,sct,vt3da,vt3db,vt3df,vt3dg,  &
     vt3dj,vt3dk,vt3do,vt3dc,dn03i,vt3dl,vt3dm,vt2db,rtgt,sfcflx,  &
     dn0,vkkh,hkkh)
  ...
  do j = ja,jz
     ...
     enddo
  enddo
end subroutine HiddenDiffsclrBrams31
