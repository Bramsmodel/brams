                   ...
                   do ng=1,ngds
                      if (oda_sfc_info(ns)%iactive(ng) == 1) then
                         oda_sfc_info(ns)%xista(ng)=  &
                              xy_ij (nnxp(ng),xtn(:,ng),stx)
                         oda_sfc_info(ns)%xjsta(ng)=  &
                              xy_ij (nnyp(ng),ytn(:,ng),sty)
                      else
