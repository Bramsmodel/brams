...
module ModReadRalph
  ...
  public :: rr_sfc_ver
  public :: rr_sfc_obs
  public :: sfc_data_convert
  public :: rr_upa_ver
  public :: rr_upa_obs
  public :: upa_get_profile
...
contains
  ...
  subroutine rr_upa_obs (ifile,qcheck,ierr)
    ...
    integer, intent(in)  :: ifile
    character(len=*), intent(in) :: qcheck
...
20  continue
  ...
  subroutine sfc_data_convert (varn,cvars,nvars)
    ...
    return
  end subroutine sfc_data_convert
  ...
  subroutine upa_get_profile (varn,nlevels,cvar,ctype)
    ...
    return
  end subroutine upa_get_profile

  !***************************************************************************

  subroutine ralph_vars (ivok,nvar,cvar,nvr,namev,unitv,cfmt)
    integer, intent(out) :: ivok
    integer, intent(in) :: nvar
    character(len=*), intent(in) :: cvar
    integer, intent(out) :: nvr
    character(len=*), intent(out) :: namev
    character(len=*), intent(out) :: unitv
    ...
    return
  end subroutine ralph_vars
end module ModReadRalph
