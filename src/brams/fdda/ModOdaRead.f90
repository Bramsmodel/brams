...
module ModOdaRead
  ...
  use mem_oda, only: &
       fnames_sfc, fnames_upa, itotdate_sfc, itotdate_upa, maxodafiles, &
       maxtimes_sfc, maxtimes_upa, maxupalevs, nsfcfiles, num_oda_sfc, &
       num_oda_upa, nupafiles, oda_sfc_info, oda_sfc_obs, oda_sfcprefix, &
       oda_upa_info, oda_upa_obs, oda_upaprefix
...
!!! stop
  ...
  subroutine oda_file_inv (iyear1,imonth1,idate1,itime1  &
    ...
    integer, intent(in) :: iyear2
    integer, intent(in) :: imonth2
    integer, intent(in) :: idate2
    integer, intent(in) :: itime2
