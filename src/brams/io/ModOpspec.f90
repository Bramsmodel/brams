...
27        format (' fatal - level must be at least'  &
    ...
    if (dyncore_flag .gt. 2) then
       write(str(1),"(i8)") dyncore_flag
       strLong="FATAL - Unavailable selected dyncore_flag option = "//trim(adjustl(str(1)))
       print *, trim(strLong)
       strLong="Available dyncore_flag options are:"
       print *, trim(strLong)
