...
module ModAvArf
  ...
  use isan_coms, only: &
       guess1st, hybbot, hybtop, is_grids, levth, nisn, nsigz, pi_p, pi_r, &
       pi_s, pi_u, pi_v, ps_p, ps_r, ps_t, ps_u, ps_v, rr_scr1, rs_qual, &
       rs_r, rs_sfp, rs_sft, rs_slp, rs_snow, rs_sst, rs_t, rs_top, rs_u, &
       rs_v, sfcinf, sigzwt
