...
module ModAsTi
  ...
  use isan_coms, only: &
       ...
       levth, maxlev, maxsfc, maxsigz, maxsta, natime, nigrids, nisn, nprx, &
       npry, nprz, nsigz, nssfc, nsta, p_lat, p_lon, p_r, p_sfp, p_sft, &
       p_slp, p_snow, p_sst, p_t, p_u, p_ur, p_v, p_vr, p_z, pi_p, pi_r, &
       pi_s, pi_u, pi_v, pp_r, pp_sglob, pp_t, pp_u, pp_v, pp_z, ps_p, &
       ps_r, ps_t, ps_u, ps_v, rs_qual, rs_sfp, rs_sft, rs_slp, rs_snow, &
       rs_sst, sf_chstid, sf_date, sf_lat, sf_lon, sf_p, sf_r, sf_s, &
       sf_scra, sf_t, sf_top, sf_u, sf_ur, sf_v, sf_vr, sigz, up_chstid, &
       up_lat, up_lon, up_lp, up_lz, up_p, up_r, up_t, up_top, up_topg, &
       up_ur, up_uz, up_vr, up_vz, up_z, up_zz, upi_p, upi_r, upi_s, upi_u, &
       upi_v, ups_p, ups_r, ups_t, ups_u, ups_v, xswlat, xswlon
