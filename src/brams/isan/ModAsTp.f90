...
module ModAsTp
  use isan_coms, only: &
       cntlat, cntlon, gdatdx, gdatdy, idate, idatelin, idd, iglobew, &
       iglobn, iglobs, ihh, ihour, imm, imonth, innpr, inproj, isversion, &
       itinc, ivertcoord, iyear, iyy, levpr, marker, maxpr, nprx, npry, &
       nprz, p_lat, p_lon, p_r, p_sfp, p_sft, p_slp, p_snow, p_sst, p_t, &
       p_u, p_ur, p_v, p_vr, p_z, pnpr, secondlat, xnelat, xnelon, xswlat, &
       xswlon
