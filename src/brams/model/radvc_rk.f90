...
subroutine copyMyPart(scp,scr,ufx_local,vfx_local,wfx_local, &
  ...
  if (dumpLocal) then
     ...
     write(str(3),"(i8)") myp
     write(str(4),"(i8)") mzi
     write(str(5),"(i8)") mzpp3
     write(str(6),"(i8)") mxi
     write(str(7),"(i8)") mxpp3
     write(str(8),"(i8)") myi
     write(str(9),"(i8)") mypp3
     call MsgDump(h//" "//vname//"("//&
          "1:"//trim(adjustl(str(1)))//","//&
          "1:"//trim(adjustl(str(2)))//","//&
          "1:"//trim(adjustl(str(3)))//") <- scp("//&
          "1:"//trim(adjustl(str(1)))//","//&
          "1:"//trim(adjustl(str(2)))//","//&
          "1:"//trim(adjustl(str(3)))//") with "//vname//"("//&
          trim(adjustl(str(4)))//":"//trim(adjustl(str(5)))//","//&
          trim(adjustl(str(6)))//":"//trim(adjustl(str(7)))//","//&
          trim(adjustl(str(8)))//":"//trim(adjustl(str(9)))//")")
     call MsgDump(h//" ufx_local <- ufx; vfx_local <- vfx; wfx_local <- wfx at the same range")
     write(str(1),"(i8)") mzp+1
     call MsgDump(h//" set to zero ufx_local, vfx_local and wfx_local at ("//&
          trim(adjustl(str(1)))//","//&
          trim(adjustl(str(6)))//":"//trim(adjustl(str(7)))//","//&
          trim(adjustl(str(8)))//":"//trim(adjustl(str(9)))//")")
  end if
...
subroutine expandBorder(mxp,myp,mzp,is,js,ks, &
  ...
  if (dumpLocal) then
     ...
     write(str(1), "(i8)") is
     call MsgDump(h//" is="//trim(adjustl(str(1))))
     write(str(1), "(i8)") js
     call MsgDump(h//" js="//trim(adjustl(str(1))))
     write(str(1), "(i8)") ks
     call MsgDump(h//" ks="//trim(adjustl(str(1))))
     write(str(1), "(i8)") mzi
     call MsgDump(h//" mzi="//trim(adjustl(str(1))))
     write(str(1), "(i8)") mzpp3
     call MsgDump(h//" mzpp3="//trim(adjustl(str(1))))
     write(str(1), "(i8)") mxi
     call MsgDump(h//" mxi="//trim(adjustl(str(1))))
     write(str(1), "(i8)") mxpp3
     call MsgDump(h//" mxpp3="//trim(adjustl(str(1))))
     write(str(1), "(i8)") myi
     call MsgDump(h//" myi="//trim(adjustl(str(1))))
     write(str(1), "(i8)") mypp3
     call MsgDump(h//" mypp3="//trim(adjustl(str(1))))
  end if
