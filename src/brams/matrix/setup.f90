module Aero_Setup
  ...
  use memMatrix, only: &
       activation_comparison, aero_spcs, aunit1, bcar_map, chem_spc_name, &
       citable, citable1, citable2, citable3, citable4, citable5, citable6, &
       citable7, citable8, conv_dpam_to_dgn, dens_comp, densp, denspi, &
       dg_acc, dg_acc_emis, dg_akk, dg_akk_emis, dg_bc1, dg_bc1_emis, &
       dg_bc2, dg_bc2_emis, dg_bc3, dg_bc3_emis, dg_bcs, dg_bcs_emis, &
       dg_boc, dg_boc_emis, dg_dbc, dg_dbc_emis, dg_dd1, dg_dd1_emis, &
       dg_dd2, dg_dd2_emis, dg_ds1, dg_ds1_emis, dg_ds2, dg_ds2_emis, &
       dg_mxx, dg_mxx_emis, dg_occ, dg_occ_emis, dg_ocs, dg_ocs_emis, &
       dg_ssa, dg_ssa_emis, dg_ssc, dg_ssc_emis, dg_sss, dg_sss_emis, dgn0, &
       dgn0_emis, diffcoef_m2s, dij, dikl, dikl_control, dikl_type, &
       discrete_eval_option, dp0, dp0_emis, dp_condtable, dp_condtable_max, &
       dp_condtable_min, dust_map, emis_dens, emis_dens_bcar, &
       emis_dens_bocc, emis_dens_dust, emis_dens_ocar, emis_dens_seas, &
       emis_dens_sulf, emis_mode_map, giklq, giklq_control, giklq_type, &
       icond, icond1, icond2, icond3, icond4, icond5, icond6, icond7, &
       icond8, include_bc3, intermodal_transfer, kappai, kappai_acc, &
       kappai_akk, kappai_bc1, kappai_bc2, kappai_bc3, kappai_bcs, &
       kappai_boc, kappai_dbc, kappai_dd1, kappai_dd2, kappai_ds1, &
       kappai_ds2, kappai_mxx, kappai_occ, kappai_ocs, kappai_ssa, &
       kappai_ssc, kappai_sss, kappapk, kappapk_bcar, kappapk_dust, &
       kappapk_ocar, kappapk_seas, kappapk_sulf, kci_coef_dp, &
       kci_coef_dp_aeq1, kci_dp_condtable, kci_dp_condtable_aeq1, lnsig0, &
       mass_acc_sulf, mass_akk_sulf, mass_bc1_bcar, mass_bc1_sulf, &
       mass_bc2_bcar, mass_bc2_sulf, mass_bc3_bcar, mass_bc3_sulf, &
       mass_bcs_bcar, mass_bcs_sulf, mass_boc_bcar, mass_boc_ocar, &
       mass_boc_sulf, mass_dbc_bcar, mass_dbc_dust, mass_dbc_sulf, &
       mass_dd1_dust, mass_dd1_sulf, mass_dd2_dust, mass_dd2_sulf, &
       mass_ds1_dust, mass_ds1_sulf, mass_ds2_dust, mass_ds2_sulf, &
       mass_map, mass_mxx_bcar, mass_mxx_dust, mass_mxx_ocar, &
       mass_mxx_seas, mass_mxx_sulf, mass_occ_ocar, mass_occ_sulf, &
       mass_ocs_ocar, mass_ocs_sulf, mass_ssa_seas, mass_ssa_sulf, &
       mass_ssc_seas, mass_ssc_sulf, mass_sss_seas, mass_sss_sulf, mech, &
       mname, mode_name, mode_numb_acc, mode_numb_akk, mode_numb_bc1, &
       mode_numb_bc2, mode_numb_bc3, mode_numb_bcs, mode_numb_boc, &
       mode_numb_dbc, mode_numb_dd1, mode_numb_dd2, mode_numb_ds1, &
       mode_numb_ds2, mode_numb_mxx, mode_numb_occ, mode_numb_ocs, &
       mode_numb_seas, mode_numb_ssa, mode_numb_ssc, mode_numb_sss, &
       mode_spcs, modes1, modes2, modes3, modes4, modes5, modes6, modes7, &
       modes8, mspcs, mw_h2so4, n_dp_condtable, naerobox, ndikl, &
       nemis_spcs, nlays, nm, nm1, nm2, nm3, nm4, nm5, nm6, nm7, nm8, &
       nm_spc_name, nmass_spcs, nmodes, nmodes_bcar, nmodes_dust, &
       nmodes_ocar, nmodes_seas, nmodes_sulf, npoints, numb_acc_1, &
       numb_acc_2, numb_akk_1, numb_akk_2, numb_bc1_1, numb_bc1_2, &
       numb_bc2_1, numb_bc2_2, numb_bc3_1, numb_bc3_2, numb_bcs_1, &
       numb_bcs_2, numb_boc_1, numb_boc_2, numb_dbc_1, numb_dbc_2, &
       numb_dd1_1, numb_dd1_2, numb_dd2_1, numb_dd2_2, numb_ds1_1, &
       numb_ds1_2, numb_ds2_1, numb_ds2_2, numb_map, numb_mxx_1, &
       numb_mxx_2, numb_occ_1, numb_occ_2, numb_ocs_1, numb_ocs_2, &
       numb_ssa_1, numb_ssa_2, numb_ssc_1, numb_ssc_2, numb_sss_1, &
       numb_sss_2, number_of_seasalt_modes, nweights, ocar_map, pi, pi6, &
       prod_index, prod_index_bcar, prod_index_dust, prod_index_ocar, &
       prod_index_seas, prod_index_sulf, recip_dens_comp, recip_part_mass, &
       recip_seas_mpp, rgas_si, rho_h2o, rho_nh42so4, seas_map, &
       seas_mode_map, seas_mode_mass_map, set_intermodal_transfer, sg_acc, &
       sg_acc_emis, sg_akk, sg_akk_emis, sg_bc1, sg_bc1_emis, sg_bc2, &
       sg_bc2_emis, sg_bc3, sg_bc3_emis, sg_bcs, sg_bcs_emis, sg_boc, &
       sg_boc_emis, sg_dbc, sg_dbc_emis, sg_dd1, sg_dd1_emis, sg_dd2, &
       sg_dd2_emis, sg_ds1, sg_ds1_emis, sg_ds2, sg_ds2_emis, sg_mxx, &
       sg_mxx_emis, sg_occ, sg_occ_emis, sg_ocs, sg_ocs_emis, sg_ssa, &
       sg_ssa_emis, sg_ssc, sg_ssc_emis, sg_sss, sg_sss_emis, sig0, &
       sig0_emis, sulf_map, theta_poly, write_log, xdij, xln_scale_dp, &
       zheight
